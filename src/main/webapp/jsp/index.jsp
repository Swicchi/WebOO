	...
	<div id="wrapper">
		...
		<header id="header">
			...
			<div class="content">
				<div class="inner">
					...
					<p>
						Farmacia de Turno: ${turno} <a href="verfarmacia?id=${id}">
							VER DETALLE</a>
					</p>
				</div>
			</div>
		...
		<div id="main">
			...
			<article id="work" width: 858.6666px>
				...
				<div id="contenedor_tabla_farmacias"
					style="color: rgb(85, 255, 85);">
					<table class="display data-table dataTable" id="example">
						<thead>
							<tr>
							...
							<c:forEach var="farmacia" items="${list}">
								<tr class="odd gradeX">
									...
									<td style="text-align: center;"><c:if
											test="${farmacia.estado == 1}">
											<p>EN TURNO</p>
											<td></td>
										</c:if> <c:if test="${farmacia.estado != 1}">
											<p>FUERA DE TURNO</p>
										</c:if></td>
								</tr>
							</c:forEach>
			...
			<article id="about">
				...
				<form method="post" action="muestraMedicamento">
					<div class="field half first">
						<label for="name">Nombre Medicamento</label> <input type="text"
							name="name" id="name" required/>
						<ul class="actions">
							<br>
							<li><input type="submit" value="Buscar" class="special"
								required /></li>
						</ul>
