...
function checkRut(rut) {
    ...
    // Aislar Cuerpo y DÌgito Verificador
    ...
    // Si no cumple con el mÌnimo ej. (n.nnn.nnn)
    ...
    // Calcular DÌgito Verificador en base al MÛdulo 11
    ...
    // Validar que el Cuerpo coincide con su DÌgito Verificador
            ...
            <div class="container-fluid">
                <div class="row">
					...
					<form role="form" action="addUser" method="post">
										...
										<div class="form-group">
                                            <label>Rut</label>
                                            <input class="form-control" oninput=" return checkRut(this)"  placeholder="Ingrese su rut" name="rut-usuarios" id="">
                                        </div>
										<div class="form-group">
								        ...
								        <div class="form-group">
                                            ...
                                            <input class="form-control"  placeholder="Ingrese su direcci√≥n" name="direccion-usuarios" id="">
                                        </div>                                
                                        <div class="form-group">
                                            <label>Telefono</label>
                                            <input class="form-control" maxlength="9" type="number" placeholder="Ingrese su numero telefonico" name="telefono-usuarios" id="">
                                        </div>
										<div class="form-group">
                                            <label>Contrase√±a</label>
                                            <input class="form-control" placeholder="Ingrese su contrase√±a" name="contrasena-usuarios" id="" type="password">
                                        </div>
